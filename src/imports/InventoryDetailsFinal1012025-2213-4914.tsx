import svgPaths from "./svg-1n5umid3we";
import imgImage53 from "figma:asset/9e2dc37b59da5220119660cad094171cdc3ab159.png";
import imgImage52 from "figma:asset/6a43a1a805049cfa33c8471b66faa8ed9655633e.png";
  ...
  return (
    <div className="absolute inset-[8.33%_8.33%_0.78%_8.73%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 13">
        <g id="Group">
          <g id="Vector"></g>
          <path d={svgPaths.p14d1bb00} fill="var(--fill-0, #44546F)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function MingcuteAiLine() {
  return (
    <div className="overflow-clip relative size-[14px]" data-name="mingcute:ai-line">
      <Group />
    </div>
  );
}
...
function NbIconTextButton() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[8px] h-[32px] items-center justify-center p-[8px] relative rounded-[3px]" data-name="--nb-icon-text-button">
      ...
      <div className="flex items-center justify-center relative shrink-0 size-[14.014px]" style={{ "--transform-inner-width": "14", "--transform-inner-height": "14" } as React.CSSProperties}>
...
function EpEdit() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="ep:edit">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="ep:edit">
          <path d={svgPaths.p210c7fc0} fill="var(--fill-0, #44546F)" id="Vector" />
          <path d={svgPaths.p11895380} fill="var(--fill-0, #44546F)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Frame9() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative">
      <div className="flex h-[32.102px] items-center justify-center min-w-[32px] relative shrink-0 w-[99.047px]" style={{ "--transform-inner-width": "94.03125", "--transform-inner-height": "32" } as React.CSSProperties}>
...
function Frame42() {
  return (
    <div className="absolute bg-white box-border content-stretch flex h-[52px] items-center justify-between left-[61px] px-[16px] py-[8px] top-[46px] w-[1303px]">
      <div aria-hidden="true" className="absolute border-[#e9edf3] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <Frame10 />
      <div className="flex h-[32.307px] items-center justify-center relative shrink-0 w-[199.146px]" style={{ "--transform-inner-width": "199.109375", "--transform-inner-height": "32.09375" } as React.CSSProperties}>
        <div className="flex-none rotate-[0.059deg]">
          <Frame9 />
        </div>
      </div>
...
function SidePanel() {
  return (
    <div className="absolute bg-[#002687] h-[1030px] left-0 overflow-clip top-[43px] w-[60px]" data-name="SIDE-PANEL">
      <div className="absolute h-[678px] left-1/2 top-[4px] translate-x-[-50%] w-[60px]" data-name="image 53">
...
function FoCell11() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[10px] h-[32px] items-center px-[12px] py-[13px] relative shrink-0 w-[128px]" data-name="--FO-Cell">
      <div aria-hidden="true" className="absolute border-[#f1f2f4] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <p className="[white-space-collapse:collapse] font-['Poppins:Medium',sans-serif] leading-[16.4px] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#172b4d] text-[12px] text-nowrap w-[116px]">{`WH-01 ,WH-03 `}</p>
    </div>
  );
}
...
function TabContents() {
  return (
    <div className="basis-0 box-border content-stretch flex gap-[4px] grow items-center justify-center min-h-px min-w-px overflow-clip pb-[5px] pt-[14px] px-0 relative shrink-0" data-name="Tab Contents">
...
function TabNewmenu() {
  return (
    <button className="box-border content-stretch cursor-pointer flex flex-col h-[36px] items-start justify-end overflow-clip pl-[16px] pr-[5px] py-0 relative shrink-0" data-name="tab_newmenu">
      <TabContents />
    </button>
  );
}
...
function Frame44() {
  return (
    <div className="content-stretch flex h-[36px] items-center relative shrink-0 w-[290px]">
      <TabNewmenu />
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="h-[168px] overflow-clip relative shrink-0 w-[262px]">
      <SidePaneTabsContent />
    </div>
  );
}
...
function TabContents1() {
  return (
    <div className="basis-0 box-border content-stretch flex gap-[4px] grow items-center justify-center min-h-px min-w-px overflow-clip pb-[6px] pt-[14px] px-0 relative shrink-0" data-name="Tab Contents">
      <div className="flex flex-col font-['Poppins:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#172b4d] text-[12px] text-center text-nowrap tracking-[0.12px]">
...
function TabNewmenu1() {
  return (
    <button className="box-border content-stretch cursor-pointer flex flex-col h-[36px] items-start justify-end overflow-clip px-[16px] py-0 relative shrink-0" data-name="tab_newmenu">
      <TabContents1 />
    </button>
  );
}
...
function Frame32() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-px items-start left-0 p-px rounded-[4px] top-0 w-[262px]">
      <div aria-hidden="true" className="absolute border border-[#f1f2f4] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Frame29 />
      <Frame30 />
      <Frame31 />
...
function Frame45() {
  return <div className="absolute bg-[#b3b9c4] h-[117px] left-[257px] rounded-[4px] top-[25px] w-[4px]" />;
}

function Frame73() {
  return (
    <div className="h-[99px] overflow-x-clip overflow-y-auto relative shrink-0 w-full">
      <Frame32 />
      <Frame45 />
    </div>
  );
...
function Frame59() {
  return (
    <div className="h-[96px] relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-[96px] items-start pb-[5px] pt-0 px-[20px] relative w-full">
          <Frame73 />
        </div>
      </div>
    </div>
...
function Frame61() {
  return (
    <div className="bg-white h-[822px] relative rounded-bl-[4px] rounded-br-[4px] shrink-0 w-full">
      <div className="h-[822px] overflow-clip relative rounded-[inherit] w-full">
        <Frame65 />
      </div>
...
function Frame39() {
  return (
    <div className="absolute content-stretch flex gap-[2px] h-[781px] items-start left-[60px] top-[98px] w-[1306px]">
      <Frame38 />
      <Frame48 />
    </div>
  );
...
export default function InventoryDetailsFinal() {
  return (
    <div className="bg-[#f3f5f7] relative size-full" data-name="Inventory Details-Final 10/1/2025">
      <div className="absolute h-[44px] left-0 top-0 w-[1366px]" data-name="image 52">
