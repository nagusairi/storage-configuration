    ...
    <div className="flex items-start justify-center py-10 px-8">
      <div className="w-full max-w-xl">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <button
            onClick={onResume}
            className="h-[32px] px-4 text-xs font-medium leading-none text-white bg-[#5C1F3D] hover:bg-[#4a1831] rounded-[3px] transition-colors whitespace-nowrap flex-shrink-0 flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={onPublish}
            className="h-[32px] px-4 text-xs font-medium leading-none text-[#5C1F3D] border border-[#5C1F3D] rounded-[3px] hover:bg-[#f9f4f7] transition-colors whitespace-nowrap flex-shrink-0 flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={onDuplicate}
            className="h-[32px] px-4 text-xs font-medium leading-none text-gray-600 border border-gray-300 rounded-[3px] hover:bg-gray-50 transition-colors whitespace-nowrap flex-shrink-0 flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={onDiscard}
            className="h-[32px] px-4 text-xs font-medium leading-none text-red-600 border border-red-200 rounded-[3px] hover:bg-red-50 transition-colors whitespace-nowrap flex-shrink-0 flex items-center justify-center gap-2"
          >
